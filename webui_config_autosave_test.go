...
func TestWebUIConfigAutosaveBindings(t *testing.T) {
	...
	numericIDs := []string{"c-session", "c-attempts", "c-timeout", "c-attempt-timeout", "c-transient-interval", "c-refresh", "c-idle", "c-idle-host", "c-max-host", "c-idle-timeout", "c-connect", "c-cooldown", "c-ratelimit-cooldown", "c-suspect-cooldown", "c-ring", "c-hist-retention", "c-hist-max"}
